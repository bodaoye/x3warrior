...
int main(int argc, char * argv[])
{
    ...
    controller_manager_node->load_controller("warrior_drive_controller", "hw_controller/WarriorDriveController");


    controller_manager_node->configure_controller("joint_state_controller");
    controller_manager_node->configure_controller("warrior_drive_controller");

    start_controllers.push_back("joint_state_controller");
    start_controllers.push_back("warrior_drive_controller");
